...
public class AuctionControllerTests
{
    ...
    public AuctionControllerTests()
    {
        ...
        _controller = new(_auctionRepo.Object, _mapper, _publishEndpoint.Object)
        {
    ...
    [Fact]
    public async Task GetAuctionById_WithInValidGuid_ReturnsNot()
    {
        // arrange
    ...
    public async Task UpdateAuction_WithUpdateAuctionDto_ReturnsOkResponse()
    {
        ...
        // act
        var result = await _controller.Update(auction.Id, updateDto);
